...
public class AppUtils {
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return TextUtil.isValidate(packageName) && IntentUtils.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (!TextUtil.isValidate(packageName)) return;
    ...
    public static boolean uninstallAppSilent(Context context, String packageName, boolean isKeepData) {
        if (!TextUtil.isValidate(packageName))  return false;
    ...
    public static String getAppName(Context context, String packageName) {
        if (!TextUtil.isValidate(packageName)) return null;
        try {
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (!TextUtil.isValidate(packageName))  return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
